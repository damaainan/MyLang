...
来源：[https://juejin.im/post/5afede99f265da0b82630af8](https://juejin.im/post/5afede99f265da0b82630af8)

时间 2018-05-21 17:37:01
...
现在前端项目开发中，都用到了webpack此等屌屌的构建工具( [如果有对webpack不熟悉使用的可移步这里][3] )，那么就结合着一起来看下如何使用到项目里吧
...
以上内容就是我在公司项目中使用到的ESLint规则，大家可以也运用到自己的项目中试试看，当然上面的规则都是可配置的，如果你有用不到的，直接把对应的规则赋为0就可以了
 
我们要做一个很有规范的Coder，让别人看到我们写的代码阅读起来无障碍，上手快，这才算是高效的开发了
 
哈哈，就说到这里吧，感谢大家了！
 


[3]: https://link.juejin.im?target=https%3A%2F%2Fjuejin.im%2Fpost%2F5adea0106fb9a07a9d6ff6de
[0]: ./img/ZN7fqab.png 
[1]: ./img/qiauaii.png 
[2]: ./img/EZJzeye.png 